...
"""
Creates a 1 by 2 plotting axis and then plots (Raster and Histogram) on them
Facecolor(Fill color) = 'None' when ploting .shps to only display bounds
set edge color to sth distinct e.g 'Yellow'
Histogram shows the Fequecny of EMR against the DN of the Raster Pixels
"""
def makePlot():
...
def calcZonalStats():
    ...
    avg_rf_portugal.plot(x = 'NAME_1', y = 'mean', kind = 'line')    
makePlot()
calcZonalStats()
